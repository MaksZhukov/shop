    ...
    return (
        <>
            ...
            <Typography>
                ...
                проводку, пластиковые детали салона, различного рода обшивки, на прокладки, сальники, ремни ГРМ, ролики,
                а так же любые резиновые детали, входящие в состав агрегата, салона и прочие детали. товары, проданные с
                дефектами, о которых покупатель был предупрежден перед покупкой. Возврат и обмен Стандартный срок
                возврата запчастей составляет 14 календарных дней со дня покупки. товара. На протяжении гарантийного
                срока товар подлежит бесплатному обмену на аналогичный или может быть осуществлен возврат стоимости
                Специальные отметки При приобретении сложных б/у запчастей, таких, как: коробки передач, коробки
                раздаточные, редукторы, детали двигателей, детали навесного оборудования двигателей, электронные блоки -
                специалисты нашей организации наносят специальные отметки краской. При установке деталей на автомобиль,
                запрещается смывать, уничтожать, снимать или частично повреждать эти отметки.
            </Typography>
            <BlockImages
            ...
            <Box marginBottom="4em" bgcolor="#FFF5DD" padding="2em 4em">
                ...
                <Box display="flex">
                    ...
                    <Box component="ul" textTransform="uppercase">
                        ...
                        <Typography variant="h6" fontWeight="normal" component="li" marginY="0.5em">
                            имеются доказательства приобретения на гродненской авторазборке Полотково Товар возврату не
                            подлежит в случае: истечения гарантийного срока
                        </Typography>
                        <Typography variant="h6" fontWeight="normal" component="li" marginY="0.5em">
