            ...
            <Box marginBottom="4em" display="flex">
                ...
                <Box marginLeft="2.5em">
                    ...
                    <Typography>
                        ...
                        доставлен в ближайшее отделение ОПС ЕвроПочты за сумму указанную в карточке товара, без оплаты
                        стоимости доставки! Для заказа используйте кнопку “Быстрый заказ”.
                    </Typography>
                </Box>
            </Box>
            ...
            <Box marginBottom="4em" display="flex" paddingTop="2em" alignItems="center">
                <Box paddingRight="3em">
                    ...
                    <Typography fontWeight="500">
                        Перед выбором данного метода доставки обязательно ознакомьтесь со списком почтовых отделений и
                        выберите наиболее подходящее для вас отделение
                    </Typography>
                </Box>
                <Box>
                    <Image
                        ...
                        isOnSSR={false}
                        alt={'Delivery Europochta'}></Image>
                </Box>
            </Box>
            <BlockImages
                imageSRCs={['/delivery_img.png', '/delivery_img.png', '/delivery_img.png']}
                sx={{ marginBottom: '-3em' }}></BlockImages>
        </>
    );
};
