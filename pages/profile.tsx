...
const Profile = observer(() => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        store.notification.showMessage({ content: <Alert variant="filled">Данные успешно обновлены</Alert> });
        setTimeout(() => {
    ...
    return (
        <Container>
            <Typography margin="1em 0" textAlign="center" variant="h4" component="h1">
                Профиль
            </Typography>
            <Box component="form" marginBottom="2em" onSubmit={handleSubmit} className={styles.content}>
                ...
                <TextField
                    ...
                    variant="standard"
                    fullWidth></TextField>
                <InputMask mask="+375 99 999 99 99" value={store.user.phone} maskChar=" " onChange={handleChangePhone}>
