...
const Privacy = () => {
	return (
		<>
			<Typography marginBottom='1em' textAlign='center' component='h1' variant='h4'>
			...
			<Typography>
				...
				и меры по обеспечению безопасности персональных данных, предпринимаемые ООО &quot;Дриблинг&quot; (далее
				– Оператор).
			</Typography>
			<Typography>
			...
			<Typography>
				...
				<NextLink href={'/'}>
					<Link component='span'>https://razbor-auto.by/</Link>.
				</NextLink>
			</Typography>
			<Typography gutterBottom marginTop='1em' fontWeight='bold'>
			...
			<Typography>3.1. Фамилия, имя, отчество;</Typography>
			<Typography>3.2. Электронный адрес;</Typography>
			<Typography>3.3. Номера телефонов;</Typography>
			<Typography>
			...
			<Typography fontWeight='bold' gutterBottom marginTop='1em'>
			...
			<Typography>
				...
				информационных сообщений, направив Оператору письмо на адрес электронной почты driblingavto@mail.ru с
			...
			<Typography>
				...
				driblingavto@mail.ru с пометкой «Актуализация персональных данных».
			</Typography>
			<Typography>
				...
				электронной почты на электронный адрес Оператора driblingavto@mail.ru с пометкой «Отзыв согласия на
			...
			<Typography>
				...
				персональных данных, обратившись к Оператору с помощью электронной почты driblingavto@mail.ru.
			</Typography>
			<Typography>
			...
			<Typography>
				...
				<NextLink href={'/privacy'}>
					<Link component='span'>https://razbor-auto.by/privacy.</Link>
				</NextLink>
			</Typography>
		</>
	);
