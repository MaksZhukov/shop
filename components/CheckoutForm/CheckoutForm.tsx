...
const CheckoutForm = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      store.notification.showSuccessMessage("Ваш заказ принят в обработку");
      store.cart.clearShoppingCart();
    } catch (err) {
      store.notification.showErrorMessage(
        "Произошла какая-то ошибка с оформлением заказа, обратитесь в поддержку"
      );
    }
  };
      ...
      <form onSubmit={handleSubmit}>
        <FormControl fullWidth>
          <TextField
            ...
            value={isUseUsernameProfile ? store.user.username : username}
            variant="standard"
        ...
        <FormControl fullWidth>
          <TextField
            ...
            value={isUseAddressProfile ? store.user.address : address}
            variant="standard"
