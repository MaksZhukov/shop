...
const getTextCategory = (
    h1?: string
) => `<br /><p>Возникла необходимость купить ${h1} для Вашего «железного друга»? Затрудняетесь сделать правильный выбор между оригинальными запчастями или их аналогами? Мы предложим надежные, качественные бу запчасти для вашего авто. Покупку можно совершить прямо на нашем сайте в один клик. Наши менеджеры всегда на связи и помогут вам как с выбором, так и с консультацией.</p>
<h2>${h1} купить с доставкой</h2>
<p>Авто разборка Дриблинг готова предложить вам качественный товар  по доступной цене.<br /><b> Товар снят с б/у автомобиля, проверен. На данный момент деталь отвечает техническим и эстетическим требованиям. Если хотите получить более детальную информацию - свяжитесь с нашим менеджером</b>. </p>
