...
const ProductItem = ({ data }: Props) => {
	...
	let thumbnailUrl = data.images
		? publicRuntimeConfig.backendUrl + data.images[0].formats.thumbnail.url
		: null;
			...
			<Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
				...
				<CardContent sx={{ flex: 1, paddingY: '0!important' }}>
					...
					<Grid columnSpacing={2} container>
						<Grid item>
							<Typography variant='subtitle2'>Марка</Typography>
							{data.brand.name}
						</Grid>
						<Grid item>
						...
						<Grid item>
							<Typography variant='h6'>Запчасть</Typography>
							{data.sparePart.name}
						</Grid>
					</Grid>
					<Typography mt='0.5em' lineClamp={1} variant='body1'>
